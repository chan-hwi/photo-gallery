...
import { List, ListItem, ListItemButton, ListItemIcon, ListItemText, Divider, TextField, InputAdornment } from '@mui/material'
...
function Sidebar() {
  return (
    <List>
        <ListItem sx={{ pb: 2 }}>
            <TextField label='검색' variant='standard' fullWidth InputProps={{ 'startAdornment': <InputAdornment position='start'><Search /></InputAdornment> }}></TextField>
        </ListItem>
